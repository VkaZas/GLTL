...
var GridPainter = exports.GridPainter = function () {
    ...
    _createClass(GridPainter, [{
        ...
        key: 'paintChar',
        value: function paintChar(index) {
        ...
        key: 'getGridPos',
        value: function getGridPos(index) {
            var $grid = this.gridList[index];
            var $row = $grid.parent('.grid-row');
            return {
        ...
        value: function moveAndroid(destIdx) {
            var destPos = this.getGridPos(destIdx);
...
var ILTL = exports.ILTL = function () {
    ...
    _createClass(ILTL, [{
        ...
        key: 'initSubTask',
        value: function initSubTask(startPos) {
            var self = this;
        ...
        value: function calcNextMove(pos) {
            ...
            if (nextState !== null) return nextState;else return {
                s1: -1,
                term: 0
            };
        }
        ...
        key: 'distScore',
        value: function distScore(mat, s0, distChar, qTuple) {
            var d = this.dist(mat, s0, distChar);
                    ...
                    for (var _iterator = dests[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        for (var _key3 in quadTuple) {
                            if (quadTuple[_key3] !== null) {
                                score += self.distScore(mat, dest, _key3, quadTuple);
                            }
                        }if (score > maxScore) {
                            maxScore = score;
                            targetDest = dest;
